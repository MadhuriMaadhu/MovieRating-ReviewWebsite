...
export default function MoviePage({ isDarkMode }) {
  const { id } = useParams();
        ...
        <div className="text-white">
          <div className="flex flex-wrap my-8">
            ...
            <section className="flex w-full md:w-1/3 lg:w-1/2 flex-1 border-2 bg-orange-900 border-red-600 justify-center items-center lg:mr-5">
              <div style={{ boxShadow: "0px 4px 10px rgba(0, 0, 0, 20)" }} className="bg-white border-2 rounded-lg shadow-lg movie-card-container">
